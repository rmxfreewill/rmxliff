<?php
  ...
  $LineLiffUrl =LINESEND_URL;
    ...
    $ShipToCode = '';
    if (isset($_POST['SHCode']))
        $ShipToCode = $_POST['SHCode'];
    if (isset($_GET['SHCode']))
        $ShipToCode = $_GET['SHCode'];
    
    $ShipToName = '';
    if (isset($_POST['SHName']))
        $ShipToName = $_POST['SHName'];
    if (isset($_GET['SHName']))
        $ShipToName = $_GET['SHName'];
...
<input type="hidden" id="txtLiffUrl" value ="<?php echo $LineLiffUrl; ?>" >
